...
{
    private bool EnsureOpenSyncRequest(INamedTypeSymbol reqDef)
    {
    ...
    private void CollectOpenSyncHandler(INamedTypeSymbol type, INamedTypeSymbol contract, List<OpenBinding> bucket, bool isVoid)
    {
